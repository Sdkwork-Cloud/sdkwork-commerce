# SDKWork Commerce Rpc Contracts Component Specs

This directory is the local standards index for `@sdkwork/commerce-rpc-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-rpc-contracts` |
| Type | `node-package` |
| Root | `sdkwork-commerce/packages/common/commerce/sdkwork-commerce-rpc-contracts` |
| Domain | `commerce` |
| Capability | `commerce` |
