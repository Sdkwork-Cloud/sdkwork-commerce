# SDKWork Commerce SDK Ports Component Specs

This directory is the local standards index for `@sdkwork/commerce-sdk-ports`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-sdk-ports` |
| Type | `node-package` |
| Root | `sdkwork-commerce/packages/common/commerce/sdkwork-commerce-sdk-ports` |
| Domain | `commerce` |
