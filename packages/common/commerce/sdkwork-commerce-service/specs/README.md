# SDKWork Commerce Service Component Specs

This directory is the local standards index for `@sdkwork/commerce-service`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-service` |
| Type | `node-package` |
| Root | `sdkwork-commerce/packages/common/commerce/sdkwork-commerce-service` |
| Domain | `commerce` |
