...
This package defines the standard domain-oriented `/app/v3/api/**` and `/backend/v3/api/**` commerce API surfaces, generated SDK operationIds, `commerce_*` table names, composable capability blocks, and amount/ledger policy helpers shared by SaaS Java and local/private Rust deployments. Public appbase commerce contracts do not expose a `billing` namespace or alias layer.
