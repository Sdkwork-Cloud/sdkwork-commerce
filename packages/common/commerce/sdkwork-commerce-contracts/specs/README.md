# SDKWork Commerce Contracts Component Specs

This directory is the local standards index for `@sdkwork/commerce-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-contracts` |
| Type | `node-package` |
| Root | `sdkwork-commerce/packages/common/commerce/sdkwork-commerce-contracts` |
| Domain | `commerce` |
