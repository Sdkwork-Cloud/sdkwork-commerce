...
This directory is the local standards index for `sdkwork_commerce_runtime`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_runtime` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-runtime-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
