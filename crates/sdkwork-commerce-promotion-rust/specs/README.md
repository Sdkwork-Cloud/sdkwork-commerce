...
This directory is the local standards index for `sdkwork_commerce_promotion`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_promotion` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-promotion-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
