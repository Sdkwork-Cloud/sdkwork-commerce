...
This README is the SDKWork module entrypoint for `sdkwork_commerce_promotion`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path crates/sdkwork-commerce-promotion-rust/Cargo.toml`
