# SDKWork Commerce Rpc Component Specs

This directory is the local standards index for `sdkwork_commerce_rpc`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_rpc` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-rpc-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
