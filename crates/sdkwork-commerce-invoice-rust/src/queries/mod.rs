...
fn validate_page(page: Option<i64>) -> Result<(), sdkwork_commerce_core::CommerceServiceError> {
    if let Some(page) = page {
        if page < 1 {
            return Err(sdkwork_commerce_core::CommerceServiceError::validation(
...
fn validate_page_size(
    page_size: Option<i64>,
) -> Result<(), sdkwork_commerce_core::CommerceServiceError> {
...
fn required_text(
    field_name: &str,
    value: &str,
) -> Result<String, sdkwork_commerce_core::CommerceServiceError> {
