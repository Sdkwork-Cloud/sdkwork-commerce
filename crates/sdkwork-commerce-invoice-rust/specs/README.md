# SDKWork Commerce Invoice Component Specs

This directory is the local standards index for `sdkwork_commerce_invoice`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_invoice` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-invoice-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
