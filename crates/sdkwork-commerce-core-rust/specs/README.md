...
This directory is the local standards index for `sdkwork_commerce_core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_core` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-core-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-core-rust/Cargo.toml`
