# SDKWork Commerce Payment Component Specs

This directory is the local standards index for `sdkwork_commerce_payment`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_payment` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-payment-rust` |
| Domain | `commerce` |
| Capability | `payment` |
| Languages | `rust` |
