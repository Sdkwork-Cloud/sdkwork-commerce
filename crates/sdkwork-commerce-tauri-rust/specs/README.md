# SDKWork Commerce Tauri Component Specs

This directory is the local standards index for `sdkwork_commerce_tauri`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_tauri` |
| Type | `tauri-host` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-tauri-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-tauri-rust/Cargo.toml`
