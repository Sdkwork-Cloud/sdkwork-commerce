# SDKWork Commerce Inventory Component Specs

This directory is the local standards index for `sdkwork_commerce_inventory`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_inventory` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-inventory-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
