# SDKWork Commerce Bootstrap Component Specs

This directory is the local standards index for `sdkwork_commerce_bootstrap`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_bootstrap` |
| Type | `tauri-host` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-bootstrap-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
