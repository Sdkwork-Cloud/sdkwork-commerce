# SDKWork Commerce Http Component Specs

This directory is the local standards index for `sdkwork_commerce_http`.
...
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-http-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-http-rust/Cargo.toml`
