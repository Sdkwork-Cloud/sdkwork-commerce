# SDKWork Commerce Membership Sqlx Component Specs

This directory is the local standards index for `sdkwork_commerce_membership_sqlx`.
...
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-membership-sqlx-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
