...
This directory is the local standards index for `sdkwork_commerce_catalog`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_catalog` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-catalog-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
