...
This README is the SDKWork module entrypoint for `sdkwork_commerce_account`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
