# SDKWork Commerce Account Component Specs

This directory is the local standards index for `sdkwork_commerce_account`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_account` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-account-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-account-rust/Cargo.toml`
