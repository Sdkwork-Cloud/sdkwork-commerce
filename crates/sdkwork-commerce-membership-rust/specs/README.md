# SDKWork Commerce Membership Component Specs

This directory is the local standards index for `sdkwork_commerce_membership`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_membership` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-membership-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
