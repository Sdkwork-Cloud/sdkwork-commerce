# SDKWork Commerce Storage Sqlx Component Specs

This directory is the local standards index for `sdkwork_commerce_storage_sqlx`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_storage_sqlx` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-storage-sqlx-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
