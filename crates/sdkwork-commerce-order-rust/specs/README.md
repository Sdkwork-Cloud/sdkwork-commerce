...
This directory is the local standards index for `sdkwork_commerce_order`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_commerce_order` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-order-rust` |
| Domain | `commerce` |
| Capability | `order` |
| Languages | `rust` |
