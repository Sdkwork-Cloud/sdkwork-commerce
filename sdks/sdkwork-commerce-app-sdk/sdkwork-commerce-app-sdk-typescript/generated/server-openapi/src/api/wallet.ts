...
/** Wallet transfers create. */
  async create(body: CommerceOperationCommand): Promise<CommerceApiResult> {
    return this.client.post<CommerceApiResult>(appApiPath(`/wallet/transfers`), body, undefined, undefined, 'application/json');
  }
}
...
export class WalletExchangesApi {
  private client: HttpClient;
...
/** Wallet exchanges create. */
  async create(body: CommerceOperationCommand): Promise<CommerceApiResult> {
    return this.client.post<CommerceApiResult>(appApiPath(`/wallet/exchanges`), body, undefined, undefined, 'application/json');
  }
}
