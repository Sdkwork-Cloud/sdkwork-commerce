...
export class InvoicesTitlesApi {
...
/** Invoices titles list. */
  async list(params?: InvoicesTitlesListParams): Promise<CommerceApiResult> {
    ...
    return this.client.get<CommerceApiResult>(appendQueryString(backendApiPath(`/invoices/titles`), query));
  }
}
