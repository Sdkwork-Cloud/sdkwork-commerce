...
export interface InventoryReservationsListParams {
  skuId?: string;
  orderId?: string;
...
export class InventoryReservationsApi {
  private client: HttpClient;
...
/** Inventory reservations list. */
  async list(params?: InventoryReservationsListParams): Promise<CommerceApiResult> {
    const query = buildQueryString([
      { name: 'sku_id', value: params?.skuId, style: 'form', explode: true, allowReserved: false },
...
export function createInventoryApi(client: HttpClient): InventoryApi {
