...
/** Fulfillments update. */
  async update(fulfillmentId: string, body?: CommerceOperationCommand): Promise<CommerceApiResult> {
    return this.client.patch<CommerceApiResult>(backendApiPath(`/fulfillments/${serializePathParameter(fulfillmentId, { name: 'fulfillmentId', style: 'simple', explode: false })}`), body, undefined, undefined, 'application/json');
  }
}
