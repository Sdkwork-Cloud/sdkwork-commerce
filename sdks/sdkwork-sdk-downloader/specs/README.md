# SDKWork SDK Downloader Component Specs

This directory is the local standards index for `@sdkwork/sdk-downloader`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/sdk-downloader` |
| Type | `node-package` |
| Root | `sdkwork-appbase/sdks/sdkwork-sdk-downloader` |
| Domain | `platform` |
| Capability | `app` |
