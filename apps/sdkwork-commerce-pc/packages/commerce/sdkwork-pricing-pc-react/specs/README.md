# SDKWork Pricing PC React Component Specs

This directory is the local standards index for `@sdkwork/pricing-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/pricing-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-pricing-pc-react` |
| Domain | `commerce` |
| Capability | `pricing` |
...
- `pnpm --filter @sdkwork/pricing-pc-react typecheck`
