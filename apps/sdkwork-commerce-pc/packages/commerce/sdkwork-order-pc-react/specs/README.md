...
This directory is the local standards index for `@sdkwork/order-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/order-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-order-pc-react` |
| Domain | `commerce` |
| Capability | `order` |
...
- `pnpm --filter @sdkwork/order-pc-react typecheck`
