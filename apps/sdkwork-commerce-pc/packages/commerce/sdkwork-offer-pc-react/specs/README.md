# SDKWork Offer PC React Component Specs

This directory is the local standards index for `@sdkwork/offer-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/offer-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-offer-pc-react` |
| Domain | `commerce` |
| Capability | `offer` |
...
- `pnpm --filter @sdkwork/offer-pc-react typecheck`
