# SDKWork Wallet PC React Component Specs

This directory is the local standards index for `@sdkwork/wallet-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/wallet-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-wallet-pc-react` |
| Domain | `commerce` |
| Capability | `wallet` |
...
- `pnpm --filter @sdkwork/wallet-pc-react typecheck`
