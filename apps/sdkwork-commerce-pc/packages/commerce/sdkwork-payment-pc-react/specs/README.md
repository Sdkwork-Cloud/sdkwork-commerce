# SDKWork Payment PC React Component Specs

This directory is the local standards index for `@sdkwork/payment-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/payment-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-payment-pc-react` |
| Domain | `commerce` |
| Capability | `payment` |
...
- `pnpm --filter @sdkwork/payment-pc-react typecheck`
