# SDKWork Checkout PC React Component Specs

This directory is the local standards index for `@sdkwork/checkout-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/checkout-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-checkout-pc-react` |
| Domain | `commerce` |
| Capability | `checkout` |
...
- `pnpm --filter @sdkwork/checkout-pc-react typecheck`
