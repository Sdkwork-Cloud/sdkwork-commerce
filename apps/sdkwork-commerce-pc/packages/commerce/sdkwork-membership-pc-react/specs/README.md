# SDKWork Membership PC React Component Specs

This directory is the local standards index for `@sdkwork/membership-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/membership-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-membership-pc-react` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/membership-pc-react typecheck`
