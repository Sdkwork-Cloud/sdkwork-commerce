# SDKWork Subscription PC React Component Specs

This directory is the local standards index for `@sdkwork/subscription-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/subscription-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-subscription-pc-react` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/subscription-pc-react typecheck`
