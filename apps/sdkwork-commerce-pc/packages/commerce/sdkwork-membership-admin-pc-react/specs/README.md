# SDKWork Membership Admin PC React Component Specs

This directory is the local standards index for `@sdkwork/membership-admin-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/membership-admin-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-membership-admin-pc-react` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/membership-admin-pc-react typecheck`
