...
This directory is the local standards index for `@sdkwork/points-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/points-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-points-pc-react` |
| Domain | `commerce` |
| Capability | `points` |
...
- `pnpm --filter @sdkwork/points-pc-react typecheck`
