# SDKWork Membership Purchase PC React Component Specs

This directory is the local standards index for `@sdkwork/membership-purchase-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/membership-purchase-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-membership-purchase-pc-react` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/membership-purchase-pc-react typecheck`
