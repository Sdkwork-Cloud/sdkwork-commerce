# SDKWork Invoice PC React Component Specs

This directory is the local standards index for `@sdkwork/invoice-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/invoice-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-invoice-pc-react` |
| Domain | `commerce` |
| Capability | `invoice` |
...
- `pnpm --filter @sdkwork/invoice-pc-react typecheck`
