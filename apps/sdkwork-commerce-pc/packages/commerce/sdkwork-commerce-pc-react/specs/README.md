# SDKWork Commerce PC React Component Specs

This directory is the local standards index for `@sdkwork/commerce-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-commerce-pc-react` |
| Domain | `commerce` |
| Capability | `commerce` |
...
- `pnpm --filter @sdkwork/commerce-pc-react typecheck`
