# SDKWork Coupon PC React Component Specs

This directory is the local standards index for `@sdkwork/coupon-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/coupon-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-coupon-pc-react` |
| Domain | `commerce` |
| Capability | `coupon` |
...
- `pnpm --filter @sdkwork/coupon-pc-react typecheck`
