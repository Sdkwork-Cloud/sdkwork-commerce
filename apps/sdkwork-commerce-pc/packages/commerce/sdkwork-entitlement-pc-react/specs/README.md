# SDKWork Entitlement PC React Component Specs

This directory is the local standards index for `@sdkwork/entitlement-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/entitlement-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-entitlement-pc-react` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/entitlement-pc-react typecheck`
