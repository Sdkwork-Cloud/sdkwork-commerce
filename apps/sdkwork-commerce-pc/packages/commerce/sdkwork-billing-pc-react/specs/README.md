# SDKWork Billing PC React Component Specs

This directory is the local standards index for `@sdkwork/billing-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/billing-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/commerce/sdkwork-billing-pc-react` |
| Domain | `commerce` |
| Capability | `billing` |
...
- `pnpm --filter @sdkwork/billing-pc-react typecheck`
