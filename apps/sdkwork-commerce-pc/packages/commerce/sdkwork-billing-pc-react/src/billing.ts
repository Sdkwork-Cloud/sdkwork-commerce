...
import { createInvoiceRouteIntent } from "@sdkwork/invoice-pc-react";
import {
  createOfferRouteIntent,
  createSdkworkCommercialAction,
  type SdkworkCommercialAction,
  type SdkworkCommercialActionCapability,
} from "@sdkwork/offer-pc-react";
import { createPaymentRouteIntent } from "@sdkwork/payment-pc-react";
...
export const billingPackageMeta = {
  ...
  domain: "commerce",
  package: "@sdkwork/billing-pc-react",
  status: "ready",
} as const;
